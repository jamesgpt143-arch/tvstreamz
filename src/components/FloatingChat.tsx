  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-20 md:bottom-6 right-4 md:right-6 z-40 bg-foreground hover:bg-foreground/90 text-background rounded-full p-3 md:p-4 shadow-lg transition-all duration-200 hover:scale-105"
      >
      ...
      {isOpen && (
        <div className="fixed bottom-36 md:bottom-24 right-4 md:right-6 z-50 w-[calc(100%-2rem)] sm:w-96 bg-card border border-border rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-in slide-in-from-bottom-5 duration-200">
          <div className="bg-muted text-foreground border-b border-border p-4 flex items-center justify-between">
            ...
            {isSent ? (
              ...
              <form onSubmit={handleSendMessage} className="flex flex-col gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <Button type="submit" disabled={isLoading || !message.trim()} className="w-full mt-2 bg-foreground hover:bg-foreground/90 text-background">
